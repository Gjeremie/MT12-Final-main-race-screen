...
lcd.drawText(1, 11, "Calibration" , SMLSIZE+INVERS) 
lcd.drawText(0, 20, "Calib. Th ESC &" , SMLSIZE) 
lcd.drawText(0, 28, "St avec Pot DR" , SMLSIZE) 

lcd.drawText(112, 18, "+R" , SMLSIZE) 
lcd.drawText(65, 51, "+L" , SMLSIZE) 

lcd.drawText(0, 39, "Th: " , SMLSIZE) 
lcd.drawText(20, 39, math.floor(getValue('ch2')/1024*100+0.5) .. " %" , SMLSIZE) -- recup valeur th ch2

lcd.drawText(0, 50, "St: " , SMLSIZE) 
lcd.drawText(20, 50, math.floor(st/1024*100+0.5) .. " %" , SMLSIZE) 
...
lcd.drawText(0, 58, "Point: " , SMLSIZE) 
...
if (st<1076 and st>972) then -- point 11	
	...
	lcd.drawText(30, 58, "0" , SMLSIZE) 

elseif (st<871 and st>767) then -- point 10
	lcd.drawText(30, 58, (point[10]-80 > 0 and "+" .. point[10]-80 or point[10]-80), SMLSIZE)
	lcd.drawRectangle(112,math.floor(37-(point[10]-80)+0.5)-1,3,3,SOLID)
		x=10
elseif (st<666 and st>582) then -- point 9	
	lcd.drawText(30, 58, (point[9]-60 > 0 and "+" .. point[9]-60 or point[9]-60), SMLSIZE)
	lcd.drawRectangle(107,math.floor(37-(point[9]-60)+0.5)-1,3,3,SOLID)
		x=9
elseif (st<462 and st>358) then -- point 8	
	lcd.drawText(30, 58, (point[8]-40 > 0 and "+" .. point[8]-40 or point[8]-40), SMLSIZE)
	lcd.drawRectangle(102,math.floor(37-(point[8]-40)+0.5)-1,3,3,SOLID)
		x=8
elseif (st<257 and st>153) then -- point 7
	lcd.drawText(30, 58, (point[7]-20 > 0 and "+" .. point[7]-20 or point[7]-20), SMLSIZE)	
...
elseif (st<-153 and st>-257) then -- point 5	
	lcd.drawText(30, 58, (-20-point[5] > 0 and "+" .. -20-point[5] or -20-point[5]), SMLSIZE)
	lcd.drawRectangle(87,math.floor(37-(point[5]+20)+0.5)-1,3,3,SOLID)
		x=5
elseif (st<-358 and st>-462) then -- point 4
	lcd.drawText(30, 58, (-40-point[4] > 0 and "+" .. -40-point[4] or -40-point[4]), SMLSIZE) 	
	lcd.drawRectangle(82,math.floor(37-(point[4]+40)+0.5)-1,3,3,SOLID)
		x=4
elseif (st<-582 and st>-666) then -- point 3
	lcd.drawText(30, 58, (-60-point[3] > 0 and "+" .. -60-point[3] or -60-point[3]), SMLSIZE)	
	lcd.drawRectangle(77,math.floor(37-(point[3]+60)+0.5)-1,3,3,SOLID)
		x=3
elseif (st<-767 and st>-871) then -- point 2	
	lcd.drawText(30, 58, (-80-point[2] > 0 and "+" .. -80-point[2] or -80-point[2]), SMLSIZE)
...
elseif (st<-972 and st>-1076) then -- point 1	
 ...
 -------------- ACTIVATION calibration steering et Th / Logical switch  LS37 
  
------ affiche valeur  -----
case(55,10,model.getLogicalSwitch(36).v2/100) -- case 
...
lcd.drawText(76, 43, "Calibration" , SMLSIZE+INVERS) -- calibration
...
if rot==30 then -------------- CALIBRATION max gaz /   channel 7 copier  ligne de mix   
   ...
   ------ affiche valeur selectionnne ------
	...
	lcd.drawText(90, 53,math.floor(10000/model.getMix(6, 2).weight)  .. " %" , SMLSIZE+INVERS) -- texte fond noir     weight
	   
    
   	if modif == rot then -- si mode modif sur cet item
	
		if getValue('input31') > 0 then -- pour pas planter le script, gachette en pos accelerer				
	...
	lcd.drawText(90, 53,math.floor(10000/model.getMix(6, 2).weight) .. " %" , SMLSIZE)  -- texte
...
if getValue('ch7') >0 then   -- valeur  input 31 (gaz) sur 100
	...
	lcd.drawText(70, 55, math.floor(getValue('ch7')/10.24*100/model.getMix(6, 2).weight), SMLSIZE) 
	else
