...
if volt == nil or voltON == false then
   ...
   soc = 9*soc/100 -- jauge de 9 barres
	...
	lcd.drawLine(59,43,60,43, SOLID, FORCE) -- Jauge
		...
		lcd.drawNumber(65, 41, math.floor(voltaff/10+0.5) , MIDSIZE+PREC2+BLINK) -- valeur tension lipo 3900mv format  affiché 3.90 V
		else
...
if temp == nil or tempON == false then
	...
	lcd.drawNumber(14, 53, math.floor(temp+0.5) , MIDSIZE+BLINK) -- valeur    temperature 
	else
...
if temp2 == nil or tempON2 == false then
	...
	if getValue('ls60')>0 then -- si alerte temperature clignote
	lcd.drawNumber(46, 53, math.floor(temp2+0.5) , MIDSIZE+BLINK) -- valeur    temperature 
	else
