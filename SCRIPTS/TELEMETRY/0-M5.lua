...
elseif (rot >11 and rot<20) then --========================    PAGE 2    ======================  
...
if rot==17 then -------------- VALEUR coeff frein Av /  Input 8
...
if rot==18 then -------------- VALEUR coeff frein Av /  Input 7
------ affiche valeur  selectionne -----
...
if rot==19 then -------------- VALEUR feeling St  Ultra Fast ou Fast ou Medium ou Slow /   channel 10 copier les ligne de mix   
...
elseif (rot >19 and rot<27) then --========================    PAGE 3    ======================  
...
lcd.drawText(1, 56, "Mode Enfant:" , SMLSIZE+INVERS) -- texte fond noir
 ...
 -- ========================== affiche valeur ========================================
   ...
   if rot==20 then -------------- VALEUR reglage duty cycle  ABS  LS20
...
if rot==21 then -------------- VALEUR reglage hold time ABS curve abs
...
lcd.drawText(lcd.getLastPos()+2, 20, ")", SMLSIZE)  
  ...
  if rot==22 then -------------- VALEUR Tps drag brake /   channel 19 copier les ligne de mix   
  ...
  if rot==23 then -------------- VALEUR agressivité drag brake /   channel 20 copier les ligne de mix   
...
pos = tab.x
 ...
 if rot==24 then -------------- VALEUR fall drag brake  /   curve 25
 ...
 if rot==25 then -------------- ACTIVATION limiteur DR bouton    /   Special Function CF11  / Logical switch  LS44 
...
case(94,46,model.getCustomFunction(10).active) -- case
   ...
   if rot==26 then -------------- VALEUR reglage mode enfant /   output 1 (ch2)
