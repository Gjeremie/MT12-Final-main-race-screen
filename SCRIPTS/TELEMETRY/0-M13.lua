...
local modif = 0 -- modif ventilo vitesse
...
lcd.drawRectangle(11, 43, 2, 3, ERASE)
...
if modif == 0 then -- si pas modif valeur FAN
...
else -- si modif valeur fan

-- Ventilateur
lcd.drawLine(23,41,31,41, SOLID, FORCE)
	lcd.drawText(17, 42, "F" , 0+INVERS)
lcd.drawText(22, 43, "AN" , SMLSIZE+INVERS)
...
mod(43,42,math.floor(model.getOutput(2).max/100+0.5),9)  -- valeur fan  

if (getValue('ch3')> 5) and math.floor(model.getOutput(2).max/100+0.5) ~= 0 then -- si ventilo en marche recup valeur de channel 3
...
if courantM == nil then
	...
	lcd.drawText(lcd.getLastRightPos()-1, 42, "A" , 0)
end
 ...
 if rpm == nil or rpmON == false then
	...
	if volt > 4800 and volt < 5500 then -- si telem hobywing perdu = esp32 envoie 5000
		lcd.drawText(15, 53, " ...." , BLINK)-- affiche vide tiret clignotant
		 ...
		 lcd.drawText(lcd.getLastRightPos()-1, 54, "K" , 0)
 ...
 if dist == nil then
	...
	-- 
 lcd.drawText(lcd.getLastRightPos()-1, 54, "m" , 0)
