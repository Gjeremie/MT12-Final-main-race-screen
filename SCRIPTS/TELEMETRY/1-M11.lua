...
-- memcapa[4] pour stocker tension lipo a 20%
local memcapatmp = 0
...
-- 0= th   1=st    2= br    4= capa    5 = eclair  6 = C  7 = thermo  8 = timer 9 = chrono  10= ventil   11 =  fleche 12 = compteur vitesse
...
lcd.drawLine(x+4,y+3,x+4,y+5, SOLID, FORCE)
lcd.drawLine(x+8,y+4,x+8,y+6, SOLID, FORCE)
lcd.drawLine(103-70,56,103-70,57, SOLID, FORCE)
lcd.drawLine(103-70,60,103-70,61, SOLID, FORCE)
lcd.drawText(82-70, 58, 9-7 , SMLSIZE)
...
if volt == nil or voltON == false then
	...
	if volt > 4800 and volt < 5500 then -- si telem hobywing perdu = esp32 envoie 5000
		...
		k =  100/ (100- ((0.0000008594 * (memcapa[4] + 3700) - 0.0105397052) * (memcapa[4] + 3700) + 43.2187106) * (memcapa[4] + 3700) + 59169.326) -- coeff correction k
		
		soc =((0.0000008594*k * voltaff -0.0105397052*k) * voltaff + 43.2187106*k) * voltaff -59169.326*k+100*(1-k) -- calcul pourcentage a partir de tension (le 0% represente encire 20 % dans batterie donc safe)
...
lcd.drawNumber(18, 53, math.floor(model.getTimer(1).value/60) , MIDSIZE ) -- minute tps ecoulé timer 2
lcd.drawNumber(36, 53, math.floor(math.fmod(model.getTimer(1).value,60)) , MIDSIZE ) -- seconde tps ecoulé timer 2
...
-- tps venant de timer 2
lcd.drawNumber(18, 53, start/60 , MIDSIZE+INVERS ) -- minute tps ecoulé timer 2
