...
lcd.drawText(32, 38, "SD Long" , SMLSIZE+INVERS) -- texte fond noir 
 lcd.drawText(lcd.getLastPos(), 38, " Start & Reset" , SMLSIZE) 
  lcd.drawText(1, 47, "timer 2, annonce minute," , SMLSIZE) 
lcd.drawText(1, 56, "log telem (icone L ou T)" , SMLSIZE)
...
lcd.drawText(1, 20, "auto lap: suite gaz, volant," , SMLSIZE) 
