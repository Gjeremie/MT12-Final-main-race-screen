...
lcd.drawText(1, 56, "si gachette en freinage" , SMLSIZE) -- texte fond noir
end  
...
lcd.drawText(1, 29, "en rotation: reglage Expo St" , SMLSIZE) 
...
lcd.drawText(lcd.getLastPos(), 11, " Modif timer 2 ou capa" , SMLSIZE) 
 lcd.drawText(1, 20, "(Alerte a 80% de capa)" , SMLSIZE) 
lcd.drawText(1, 29, "ROTARY" , SMLSIZE+INVERS) -- texte fond noir
 lcd.drawText(lcd.getLastPos(), 29, " Choix valeurs telem" , SMLSIZE) 
    ...
    if rot == 5 then -- PAGE   
lcd.drawText(1, 1, "PAGE 1: accueil 4                   " , 0+INVERS) -- TITRE	  
 
lcd.drawText(1, 11, "SD" , SMLSIZE+INVERS) -- texte fond noir
 lcd.drawText(lcd.getLastPos(), 11, " lap (Icon L): tour par" , SMLSIZE) 
   lcd.drawText(1, 20, "tour depuis 1er appui SD" , SMLSIZE) 
lcd.drawText(1, 29, "SD Long" , SMLSIZE+INVERS) -- texte fond noir 
 lcd.drawText(lcd.getLastPos(), 29, " Timer (icon T) start" , SMLSIZE) 
  lcd.drawText(0, 38, "reset: 1er passage ne compte" , SMLSIZE) 
lcd.drawText(0, 47, "pas et le Timer start au gaz," , SMLSIZE)
lcd.drawText(0, 56, "annonce minute, log telem" , SMLSIZE)
end  
...
if rot == 8 then -- PAGE   
	lcd.drawText(1, 1, "PAGE 4: Lap timer 1                       " , 0+INVERS) -- TITRE  
  
  
    lcd.drawText(1, 11, "Trigger lap auto" , SMLSIZE+INVERS) -- texte fond noir
lcd.drawText(lcd.getLastPos(), 11, "  Declenche" , SMLSIZE) 
lcd.drawText(1, 20, "auto lap: suite de gaz, RPM," , SMLSIZE) 
lcd.drawText(0, 29, "GPS. Lap 0 reste manuel au" , SMLSIZE) 
...
if rot == 9 then -- PAGE   
	lcd.drawText(1, 1, "PAGE 4: Lap timer 2                        " , 0+INVERS) -- TITRE  
  
  
    lcd.drawText(1, 11, "Annonce Tps Secteur" , SMLSIZE+INVERS) -- texte fond noir
lcd.drawText(lcd.getLastPos(), 11, "  Annonce" , SMLSIZE) 
lcd.drawText(0, 20, "temps avance ou retard par" , SMLSIZE) 
lcd.drawText(0, 29, "rapport au meilleur temps" , SMLSIZE) 
lcd.drawText(0, 38, "point GPS premier secteur." , SMLSIZE) 
    lcd.drawText(1, 47, "Def pos" , SMLSIZE+INVERS) -- texte fond noir
	lcd.drawText(lcd.getLastPos(), 47, "  Definir point GPS" , SMLSIZE) 
	lcd.drawText(0, 56, "avec ENTER ou Switch SD" , SMLSIZE) 
end  



if rot == 10 then -- PAGE 	  
	lcd.drawText(1, 1, "PAGE 5: configuration 1                   " , 0+INVERS) -- TITRE  
...
if rot == 11 then -- PAGE 	  
	lcd.drawText(1, 1, "PAGE 5: configuration 2                   " , 0+INVERS) -- TITRE  
...
if rot == 12 then -- PAGE 	  
	lcd.drawText(1, 1, "PAGE 5: configuration 3                   " , 0+INVERS) -- TITRE  
...
if rot == 13 then -- PAGE 	  
	lcd.drawText(1, 1, "PAGE 5: configuration 4                   " , 0+INVERS) -- TITRE  
...
if rot == 14 then -- PAGE   
	lcd.drawText(1, 1, "PAGE 6: LOG Viewer                        " , 0+INVERS) -- TITRE  
...
if rot == 15 then -- PAGE 	  
	lcd.drawText(1, 1, "PAGE 7: GPS sessions                  " , 0+INVERS) -- TITRE  
    
	lcd.drawText(1, 11, "Fichier -GPS.txt" , SMLSIZE+INVERS) -- texte fond noir

lcd.drawText(76, 11, "permet de" , SMLSIZE) 
lcd.drawText(1, 20, "lier loc GPS a nom du circuit" , SMLSIZE)
lcd.drawText(1, 29, "(max 6 caracteres) pour" , SMLSIZE)    
lcd.drawText(1, 38, "afficher dans les sessions" , SMLSIZE)   
...
lcd.drawText(1, 29, "et timer et gps" , SMLSIZE)
    lcd.drawText(1, 38, "Drive mode" , SMLSIZE+INVERS) -- texte fond noir
lcd.drawText(lcd.getLastPos(), 38, " a renommer pour" , SMLSIZE) 
lcd.drawText(1, 47, "chaque model" , SMLSIZE) 
end  
